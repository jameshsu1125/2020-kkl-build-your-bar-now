...
export default class quadrant extends React.Component {
	constructor(props) {
		...
		this.tr = {
			...
			tran() {
				this.c.css('margin-top', this.y + 'px');
			},
		};
	}
	...
	componentDidMount() {
		...
		$(window).on('hashchange', () => {
			...
			let dat = [
				{ hash: '38度金門高粱酒', top: 975 },
				{ hash: '58度金門高粱酒', top: 1907 },
				{ hash: '罈裝金門高粱酒', top: 2465 },
				{ hash: '金酒典藏珍品', top: 3221 },
				{ hash: '陳年金門高粱酒', top: 3946 },
				{ hash: '金門高粱酒 原釀21', top: 4703 },
				{ hash: '特優 金門高粱酒', top: 6280 },
				{ hash: '戰酒黑金龍', top: 5699 },
				{ hash: '罈裝金門大高酒', top: 7004 },
			];
			for (var i in dat) {
				if (hash === dat[i].hash) this.scorllTo(dat[i].top);
			}
		});
	...
	scorllTo(y) {
		let nt = $(this.refs.main).scrollTop(),
